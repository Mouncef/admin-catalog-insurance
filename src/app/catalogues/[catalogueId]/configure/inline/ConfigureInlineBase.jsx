...
export default function ConfigureCatalogueInlineBase({catalogueId, targetRisk = null}) {
        ...
        return (
            <div className="p-6 max-w-3xl">
                <div className="alert alert-error">
                    <span>ID de catalogue manquant.</span>
                </div>
                <div className="mt-4">
        ...
        return (
            <div className="p-6 max-w-3xl">
                <div className="alert alert-warning">
                    <span>
                        Ce catalogue est associé au risque <span className="font-mono">{catalogueRisk}</span>{' '}
                        et ne peut pas être configuré via l’espace{' '}
                        <span className="font-mono">{targetRisk}</span>.
                    </span>
                </div>
                <div className="mt-4">
                    <button className="btn" onClick={() => router.push('/catalogues')}>← Retour à la liste</button>
