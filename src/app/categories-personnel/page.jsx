...
export default function CatPersonnelPage() {
    ...
    function sanitizeList(arr) {
        ...
        cleaned.sort((a, b) => (a.ordre ?? 1e9) - (b.ordre ?? 1e9) || a.code.localeCompare(b.code))
                ...
                <div className="card-body p-0">
                    <div className="overflow-x-auto">
                        <table className="table table-zebra">
                            ...
                            {pageRows.length === 0 && (
                                <tr>
                                    <td colSpan={5}><div className="p-6 text-center opacity-70">Aucune entrée.</div></td>
                                </tr>
                            )}
                            {pageRows.map((it) => (
                                <tr key={it.id}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                            <label className="floating-label md:col-span-8">
                                ...
                                <input
                                    ...
                                    placeholder="Ex: Non cadres, Cadres…"
                                />
                            </label>
